...
//HBL230425 namespace SI4463_NSTDPREAMBLE_NOFLAG
//HBL230425 {
 ...
 *  Global Variables
 *****************************************************************************/
const SEGMENT_VARIABLE(si4463_Radio_Configuration_Data_Array[], uint8_t, SEG_CODE) = RADIO_CONFIGURATION_DATA_ARRAY;
 ...
 *****************************************************************************/
static void si4463_vRadio_PowerUp(void);
 ...
 *
 */
void si4463_vRadio_PowerUp(void)
{
 ...
 * Configuration
 */
void si4463_vRadio_Version()
{
	_info("NSTDPREAMBLE_NOFLAG");
}
...
void si4463_vRadio_Init(void)
{
	...
	si4463_vRadio_PowerUp();

	_info("si4463_vRadio_Init");
 ...
 *
 */
uint8_t si4463_bRadio_Check_Tx_RX()
{
	uint8_t rtn_u8;
	rtn_u8=0;
 ...
 *
 */
void si4463_vRadio_StartRX(uint8_t channel, uint8_t packetLenght )
{
	// Read ITs, clear pending ones
	si446x_get_int_status(0u, 0u, 0u);
 ...
 *
 */
void si4463_vRadio_StartTx_Variable_Packet(uint8_t channel, uint8_t *pioRadioPacket, uint8_t length)
{
...
//HBL230425 }// SI4463_NSTDPREAMBLE_NOFLAG
