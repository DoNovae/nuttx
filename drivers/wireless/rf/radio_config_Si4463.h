 ...
 */
#ifndef RADIO_CONFIG_H_4463
#define RADIO_CONFIG_H_4463
...
*/
#define RF_GPIO_PIN_CFG 0x13, 0x58, 0x5A, 0x00, 0x27, 0x67, 0x00, 0x00
...
*/
#define RF_MODEM_BCR_NCO_OFFSET_2_12 0x11, 0x20, 0x0C, 0x24, 0x06, 0x8D, 0xB9, 0x00, 0x00, 0x00, 0xD0, 0x08, 0x00, 0x12, 0x00, 0x69
...
*/
//HBL #define RF_INT_CTL_ENABLE_4 0x11, 0x01, 0x04, 0x00, 0x07, 0x18, 0x06, 0x08
#define RF_INT_CTL_ENABLE_4 0x11, 0x01, 0x04, 0x00, 0x01, 0x10, 0x00, 0x00
...
*/
// HBL #define RF_PREAMBLE_TX_LENGTH_9 0x11, 0x10, 0x09, 0x00, 0x06, 0x18, 0x0C, 0x00, 0x80, 0xCC, 0xCC, 0xCC, 0xCC
// TX_LENGTH = 3 bytes / 6 nibbles - RX_THRESHOLD=12 bits bits max + Flag 1 byte
//#define RF_PREAMBLE_TX_LENGTH_9 0x11, 0x10, 0x09, 0x00, 0x06, 0x18, 0x0C, 0x00, 0x80, 0xCC, 0xCC, 0xCC, 0xCC
// TX_LENGTH = 3 bytes / 6 nibbles - RX_THRESHOLD=16 bits bits max + Flag 4 bits
#define RF_PREAMBLE_TX_LENGTH_9 0x11, 0x10, 0x09, 0x00, 0x06, 0x18, 0x10, 0x00, 0x80, 0xCC, 0xCC, 0xCC, 0xCC
...
*/
// Flag 8 bits
//#define RF_SYNC_CONFIG_6 0x11, 0x11, 0x06, 0x00, 0x80, 0xCC, 0xCC, 0xCC, 0xCC, 0x00
// Flag 4 bits
#define RF_SYNC_CONFIG_6 0x11, 0x11, 0x06, 0x00, 0x80, 0xCC, 0xCC, 0xCC, 0xCC, 0x02
...
*/
#define RF_PKT_CRC_CONFIG_12 0x11, 0x12, 0x0C, 0x00, 0x00, 0x01, 0x08, 0xFF, 0xFF, 0x20, 0x01, 0x00, 0x00, 0x00, 0x00, 0x30
...
*/
#define RF_PKT_RX_THRESHOLD_12 0x11, 0x12, 0x0C, 0x0C, 0x14, 0x00, 0x1F, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00
...
//   MODEM_BCR_OSR_0 - RX BCR/Slicer oversampling rate (12-bit unsigned number).
*/
#define RF_MODEM_TX_RAMP_DELAY_12_1 0x11, 0x20, 0x0C, 0x18, 0x01, 0x80, 0x08, 0x02, 0x80, 0x00, 0x70, 0x10, 0x00, 0xE8, 0x00, 0x41
...
//   MODEM_AFC_GAIN_0 - Sets the gain of the PLL-based AFC acquisition loop, and provides miscellaneous control bits for AFC functionality.
*/
#define RF_MODEM_BCR_NCO_OFFSET_2_12_1 0x11, 0x20, 0x0C, 0x24, 0x07, 0xDD, 0x44, 0x03, 0xF0, 0x00, 0xC2, 0x00, 0x14, 0x23, 0x80, 0xAA
...
//   MODEM_AFC_MISC - Specifies miscellaneous AFC control bits.
*/
#define RF_MODEM_AFC_LIMITER_1_3_1 0x11, 0x20, 0x03, 0x30, 0x02, 0xA2, 0x80
...
//   MODEM_OOK_MISC - Selects the detector(s) used for demodulation of an OOK signal, or for demodulation of a (G)FSK signal when using the asynchronous demodulator.
*/
#define RF_MODEM_AGC_WINDOW_SIZE_12_1 0x11, 0x20, 0x0C, 0x38, 0x11, 0x0E, 0x0E, 0x80, 0x1A, 0x20, 0x00, 0x00, 0x28, 0x0C, 0x84, 0x23
...
//   MODEM_RSSI_COMP - RSSI compensation value.
*/
#define RF_MODEM_RAW_CONTROL_10 0x11, 0x20, 0x0A, 0x45, 0x8F, 0x00, 0x9F, 0x01, 0x00, 0xFF, 0x06, 0x03, 0x18, 0x40
...
#define RADIO_CONFIGURATION_DATA { \
							(U8*)si4463_Radio_Configuration_Data_Array,\
